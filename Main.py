...
def Gaussian_method(sle):
    ...
    return list_of_approximate_roots
...
def find_delta(orig_sle, eps):
    ...
    return Gaussian_method(new_sle)
...
if __name__ == '__main__':
    ...
    approximate_roots = Gaussian_method(SLE)
